            ...
            <form method="post">
                <fieldset>
                    ...
                    <table>
                        <tr>
                            <td>Họ Tên :</td>
                            <td><input type="text" name="hoten" id="name" value="${requestScope["employee"].getHoTen()}"></td>
                        </tr>
                        <tr>
                            <td>Ngày Sinh :</td>
                        ...
                        <tr>
                            <td></td>
                            <td><input type="submit" value="Update employee"  class="btn btn-outline-success"></td>
                        </tr>
                    </table>
                </fieldset>
            </form>
